...
for i in range(len(states[0])):
    ...
    bot2 = AI(0.01, 0.05, [0.73014566, 0.24268174, 0.09902827, 0.09862708], 1, [states[0][i], states[1][i]], 0.0001)
...
plt.plot(np.linspace(0, 1, 100), optimo, label="Óptimo numérico", linestyle="--", color="#D81B60")
