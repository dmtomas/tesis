...
plt.scatter(states_AI, recompenza(states_AI, disp_AI), label="Solución IA", color="#D81B60", s=15, zorder=1)
plt.plot(states, optimo, label="solución numérica", color="#1E88E5", zorder=0)
plt.xlabel(r"$\alpha$")
